...
library(ggplot2)
png('./figures/model2replicatedMeans.png', width = 600*scalingCoef, height = 400*scalingCoef)
...
png('./figures/model2replicatedMedians.png', width = 600*scalingCoef, height = 400*scalingCoef)
...
library(ggplot2)
png('./figures/model2replicatedMeansHelsinki.png', width = 600*scalingCoef, height = 400*scalingCoef)
...
png('./figures/model2replicatedMeansEspoo.png', width = 600*scalingCoef, height = 400*scalingCoef)
par(mar = c(8.1, 5.1, 4.1, 2.1))
...
png('./figures/model2replicatedMeansVantaa.png', width = 600*scalingCoef, height = 400*scalingCoef)
par(mar = c(8.1, 5.1, 4.1, 2.1))
...
hist(PITsample.estimation, 
     ...
     main = "PIT histogram, estimation set, model 2",
     probability = T)
dev.off()
...
png('./figures/model2EstimationSet90CredIntSharpnessHistogram.png', width = 600*scalingCoef, height = 400*scalingCoef);  
hist(credibleIntervalWidths.90.estimation, 
     xlab = "width", 
     main = "Sharpness histogram, 90 % credible interval width, model 2",
     #xlim = c(180000,240000),
     nclass = 50)
abline(h=0)
dev.off();
...
png('./figures/model2EstimationSetMeanPredScatter.png', width = 600*scalingCoef, height = 400*scalingCoef);  
...
png('./figures/model2TestSetMeanPredScatter.png', width = 600*scalingCoef, height = 400*scalingCoef);  
...
png('./figures/model2TestSetProblemObservations.png', width = 600*scalingCoef, height = 400*scalingCoef);  
par(mfrow=c(3,3)); 
...
png('./figures/model2interceptsBoxplots.png', width = 1600, height = 1200)
par(mfrow=c(1,3))
